    ...
    <div class="container mt-5 text-center" >
        <div class="row " style="margin-top:10%;width:130%;height:70vh;">
            ...
            <div class="first col-md-6 border p-3" >
                <section class="sec-container" style="margin-top:19%;">
                    <p class="mt-4">Are you physically active?</p>
                    <p class="small">Being inactive can increase your risk for type 2 diabetes.</p><br>
                ...
                <div class="form-container" style="background-color: #53c4ba; width:40vh;height:70vh;">
                    <form>
                        <section class="sec-container">
                            <img src="images\jocking.png" class="img-fluid" style="margin-top:35%; width:80%;">
                        </section>
                    </form>
                </div>
            </div>
