...
function validateWardno(){
  var wardno1 = document.getElementById("wardno").value;
  if (wardno1 == "") {
    document.getElementById("msg").innerHTML = "Please Enter Ward No";
    return false;
  }else if (wardno1.length > 4) {
    document.getElementById("msg").innerHTML =
      "Please Enter a Ward No value that is 4 characters or less";
    return false;
  } else if (!/^[^0]/.test(wardno1)) {
    document.getElementById("msg").innerHTML =
      "Please Enter a Ward No value that doesn't start with 0";
    return false;
  }
}

function validateBedno(){
  var bedno1 = document.getElementById("bedno").value;
  if (bedno1 == "") {
    document.getElementById("msg").innerHTML = "Please Enter Bed No";
    return false;
  }else if (bedno1.length > 4) {
    document.getElementById("msg").innerHTML =
      "Please Enter a Bed No value that is 4 characters or less";
    return false;
  } else if (!/^[^0]/.test(bedno1)) {
    document.getElementById("msg").innerHTML =
      "Please Enter a Bed No value that doesn't start with 0";
    return false;
  }
}
